...
public  class  SavingCal extends AbstractGUI  {
	...
	public void addListeners() {
		// ボタンに自作リスナーを登録
		addClearButtonListener() ; //クリアボタンにリスナーを登録
		addCalcButtonListener() ; //計算ボタンにリスナーを登録
		addCursorListener() ; //ボタンの上にカーソルが来た時にその形を変えるリスナーを登録
	}


	//ボタンの上にカーソルが来た時にその形を変えるリスナーを登録するメソッド
	...
	public void setTfNames(String[] names) {
		this.tfNames= names ;
	}
	public void setBtnNames(String[] names) {
		this.btnNames= names ;
	}
